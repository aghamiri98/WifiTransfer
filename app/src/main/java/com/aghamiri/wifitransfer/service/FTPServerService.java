package com.aghamiri.wifitransfer.service;
...
import com.aghamiri.wifitransfer.activities.ActivityFtpService;
...
import com.aghamiri.wifitransfer.swiftp.ProxyConnector;
import com.aghamiri.wifitransfer.swiftp.SessionThread;
import com.aghamiri.wifitransfer.swiftp.TcpListener;
import com.aghamiri.wifitransfer.swiftp.UiUpdater;
import com.aghamiri.wifitransfer.swiftp.Util;
...
public class FTPServerService extends Service implements Runnable {
    ...
    private void setupNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(FTPServerService.this);
        Intent notificationIntent = new Intent(this, ActivityFtpService.class);
    ...
    private void takeWifiLock() {
        ...
        Context myContext = Globals.getContext();
        if (wifiLock == null) {
            WifiManager manager = (WifiManager)myContext.getApplicationContext().getSystemService(Context.WIFI_SERVICE);
