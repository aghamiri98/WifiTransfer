package com.aghamiri.wifitransfer.activities;
...
import com.aghamiri.wifitransfer.R;
import com.aghamiri.wifitransfer.service.FTPServerService;
import com.aghamiri.wifitransfer.swiftp.Defaults;
import com.aghamiri.wifitransfer.swiftp.Globals;
import com.aghamiri.wifitransfer.swiftp.MyLog;
import com.aghamiri.wifitransfer.swiftp.UiUpdater;

import java.io.File;
import java.net.InetAddress;

public class ActivityFtpService extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setUpToolbar(this.getResources().getString(R.string.app_name));


    // Set the application-wide context global, if not already set
    Context myContext = Globals.getContext();
    if (myContext == null) {
      myContext = ActivityFtpService.this.getApplicationContext();
      if (myContext == null) {
  ...
  public void onResume() {
    ...
    ActivityFtpService.this.registerReceiver(wifiReceiver, filter);
  }
  ...
  public void onPause() {
    ...
    ActivityFtpService.this.unregisterReceiver(wifiReceiver);
  }
  ...
  public void updateUi() {
    ...
    WifiManager wifiMgr = (WifiManager) ActivityFtpService.this.getApplicationContext().getSystemService(Context.WIFI_SERVICE);
    ...
    wifiImg.setImageResource(isWifiReady ? R.drawable.wifi_state_on : R.drawable.wifi_state_off);
    ...
    if (running) {
      ...
      if (address != null) {
        ...
        Context context = ActivityFtpService.this.getApplicationContext();
    ...
    if (isWifiReady) {
      startStopButton.setText(running ? R.string.stop_server : R.string.start_server);
      startStopButton.setCompoundDrawablesWithIntrinsicBounds(running ? R.drawable.disconnect
        : R.drawable.connect, 0, 0, 0);
      startStopButton.setTextColor(running ? getResources().getColor(R.color.textPrimary)
      ...
      startStopButton.setText(R.string.no_wifi);
      startStopButton.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
  ...
  private void warnIfNoExternalStorage() {
    ...
    if (!storageState.equals(Environment.MEDIA_MOUNTED)) {
      ...
      Toast toast = Toast.makeText(ActivityFtpService.this, R.string.storage_warning, Toast.LENGTH_LONG);
  ...
  boolean requiredSettingsDefined() {
    SharedPreferences settings = ActivityFtpService.this.getSharedPreferences(Defaults.getSettingsName(), Defaults.getSettingsMode());
  ...
  SharedPreferences getSettings() {
    ...
    if (settings != null) {
      ...
      return ActivityFtpService.this.getPreferences(Activity.MODE_PRIVATE);
    }
  }
